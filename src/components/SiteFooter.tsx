    ...
    >
      ...
      <div
        style={{
          ...
          height: "90%",
          background:
            "radial-gradient(ellipse at 65% 25%, rgba(212,177,137,0.18) 0%, transparent 68%)",
          filter: "blur(65px)",
          pointerEvents: "none",
          zIndex: 0,
        }}
      ...
      />
      {/* Halo rose subtil — touche charte */}
      <div
        aria-hidden
        style={{
          position: "absolute",
          ...
          height: "60%",
          background:
            "radial-gradient(ellipse at 50% 50%, rgba(230,180,174,0.12) 0%, transparent 70%)",
          filter: "blur(70px)",
          pointerEvents: "none",
          zIndex: 0,
        }}
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "2.2rem" }}>
              <div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "3px" }}>
                  ...
                  >
                    Assistante digitale spécialisée
                    <br />
