...
export const Route = createFileRoute("/a-propos")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Mélody Roche, fondatrice de MELIYA. Assistante digitale spécialisée en mise en forme et valorisation de supports professionnels depuis 2005." },
    ],
  }),
  component: APropos,
});
  ...
  return (
    <span
      ...
      style={{
        ...
        whiteSpace: "nowrap",
        color: hovered ? "#8C6A43" : "#8C6A43",
        background: hovered
          ? "rgba(212,184,150,0.22)"
          : "rgba(255,255,255,0.75)",
        border: hovered
          ? "0.5px solid rgba(212,168,67,0.55)"
          : "0.5px solid rgba(212,168,67,0.3)",
...
function ToolLogo({ name, src, size = 44 }: { name: string; src: string; size?: number }) {
  ...
  return (
    ...
    >
      ...
      />
      <span style={{
        fontSize: "9.5px", fontFamily: "var(--font-display)",
        letterSpacing: "0.1em", textTransform: "uppercase",
        color: "#8C6A43", opacity: hovered ? 0.7 : 0.4,
  ...
  return (
    <div lang="fr" style={{ minHeight: "100vh" }}>
      ...
      <div style={{
        ...
        <div className="orb orb-rose" style={{ width: 360, height: 360, top: "-80px", right: "-60px" }} />
        <div style={{ position: "relative", maxWidth: "720px", margin: "0 auto" }}>
          ...
          >
            L'élégance au service<br />de vos supports professionnels.
          </h1>
      ...
      <div style={{ maxWidth: "720px", margin: "0 auto", padding: "4.5rem 1.5rem 0" }}>
        ...
        >
          Depuis 2005, j'ai évolué comme assistante administrative au sein d'entreprises aux univers et secteurs d'activité variés. Cette expérience m'a permis de développer une grande capacité d'adaptation, une vision globale des besoins professionnels et un sens aigu du détail.
        </p>
        ...
        >
          Avec le temps, une évidence s'est imposée : ce qui me passionne réellement, c'est révéler le potentiel de chaque contenu. Donner à une présentation, un rapport ou un dossier la forme qu'il mérite — pour qu'il soit lu, retenu et valorisé.
        </p>
        ...
        >
          C'est donc tout naturellement que j'ai choisi de laisser le volet purement administratif derrière moi afin de me consacrer pleinement à ce que j'aime profondément : la création de supports professionnels élégants, structurés et visuellement impactants.
        </p>
        ...
        >
          Aujourd'hui, à travers MELIYA, j'accompagne entreprises, indépendants et associations dans la mise en valeur de leurs idées grâce à des documents clairs, cohérents et soignés.
        </p>
        ...
        >
          J'ai ainsi eu l'opportunité d'accompagner des professionnels issus de secteurs très différents, développant une approche à la fois humaine, polyvalente et exigeante de la communication visuelle.
        </p>
        ...
        >
          Chaque création est pensée avec une même intention : transformer un simple document en une expérience professionnelle mémorable.
        </p>
      </div>
      ...
      <div style={{ maxWidth: "960px", margin: "0 auto", padding: "0 1.5rem" }}>
        <div style={{
          ...
          >
            {[
              "Médical", "Immobilier", "Social", "Viticole",
              "Automobile", "Associatif", "Commerce", "Relation client",
            ].map((s) => (
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          ...
          <div
            ...
            style={{
              ...
              boxShadow: "0 4px 32px rgba(197,163,116,0.08), inset 0 1px 0 rgba(255,255,255,0.8)",
            }}
          >
            <div style={{
            ...
            <h2 className="display" style={{ fontSize: "20px", color: "#8C6A43", marginBottom: "1rem" }}>
              Ma mission
            </h2>
            <p className="serif italic" style={{ fontSize: "16px", color: "#8C6A43", lineHeight: 1.65, opacity: 0.85 }}>
            ...
            <p style={{
              marginTop: "1rem", fontSize: "13.5px", color: "#8C6A43", opacity: 0.65,
            ...
            <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "10px" }}>
              {[
                ...
                <li key={item} style={{
                  ...
                  fontSize: "13.5px", color: "#8C6A43", fontFamily: "var(--font-sans)",
                  lineHeight: 1.55,
                }}>
                  <span style={{ color: "#C5A374", flexShrink: 0, marginTop: "1px" }}>✦</span>
                  {item}
                </li>
              ))}
            </ul>
            <p style={{
              marginTop: "1.25rem", fontSize: "13px", color: "#8C6A43", opacity: 0.6,
              fontFamily: "var(--font-sans)", lineHeight: 1.65,
              fontStyle: "italic",
            }}>
              Le véritable enjeu aujourd'hui n'est plus de savoir faire —
              mais de <strong style={{ fontStyle: "normal", opacity: 0.85 }}>savoir structurer et valoriser</strong>.
            </p>
          </div>
        </div>
      </div>
      ...
      <div style={{ maxWidth: "720px", margin: "0 auto", padding: "2rem 1.5rem 0" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "3rem" }}>
          ...
          <p className="serif italic" style={{ fontSize: "16px", color: "#8C6A43", opacity: 0.7 }}>
        ...
        <div style={{ marginBottom: "2.5rem" }}>
          <p style={{
            textAlign: "center", fontSize: "9.5px",
            fontFamily: "var(--font-display)", letterSpacing: "0.22em",
            textTransform: "uppercase", color: "#C5A374", marginBottom: "1.75rem",
          }}>
            Outils & Applications
          </p>
          <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", alignItems: "flex-end", gap: "40px" }}>
            {[
      ...
      <div style={{ maxWidth: "960px", margin: "0 auto", padding: "0 1.5rem 5rem" }}>
        <div
          className="bento-card reveal"
          style={{
            background: "linear-gradient(145deg, #C5A374 0%, #D9BF9A 55%, #EFDBC3 100%)",
            border: "0.5px solid rgba(255,255,255,0.35)",
            boxShadow:
              "0 20px 60px rgba(197,163,116,0.22), 0 0 80px rgba(197,163,116,0.10), inset 0 1px 0 rgba(255,255,255,0.45)",
            textAlign: "center",
        ...
        >
          ...
          <div aria-hidden="true" style={{
            ...
            background: "radial-gradient(ellipse at center, rgba(197,163,116,0.12) 0%, transparent 72%)",
            filter: "blur(28px)", pointerEvents: "none",
          }} />
          <div aria-hidden="true" style={{
            position: "absolute", bottom: "-40px", left: "-40px",
            width: "200px", height: "200px", borderRadius: "50%",
            background: "radial-gradient(ellipse at center, rgba(197,163,116,0.10) 0%, transparent 70%)",
          ...
          <p className="serif italic" style={{
            ...
            J'accompagne indépendants, entreprises, associations et particuliers
            qui souhaitent donner à leurs supports la qualité qu'ils méritent.
          </p>
