...
const faqs = [
  ...
  { q: "Combien de retouches sont incluses ?", a: "2 séries de retouches sont incluses dans tous les tarifs unitaires et le pack visuel. Au-delà, des retouches complémentaires sont facturées au tarif horaire." },
  ...
  { q: "Le pack visuel à 490€ remplace-t-il un graphiste ?", a: "Non. Il s'agit d'une aide au démarrage pour les créateurs d'entreprise qui ont besoin d'une identité cohérente rapidement. Pour un projet de branding complet et stratégique, je vous recommande un graphiste designer." },
